...
const RESULTS_COLS = [
  { key: 'A', width: COL_SIZE.xs },
  { key: 'B', width: COL_SIZE.xxl },
...
const getFontExtended = (size, bold) => {
  return {
    name: 'Cambria',
    color: { argb: '00000000' },
    family: 2,
...
const TEST_DATA = {
  ...
  teams: [
    { name: 'Team 1', id: 'choop' },
    { name: 'Team 2', id: 'Maaaaaa' },
    { name: 'Team 3', id: 'LOOOOOO' }
  ],
  fighters: [
    { name: 'Derek', id: 'doc' },
